...
<div class="box-shadow">
            ...
            <div class="row position-relative h-100">
                <div class="w-100 item-check-classify padding-left-right margin-bottom-10">
                    <div class="form-check form-switch form-check-input-classify">
                        <input class="form-check-input" type="checkbox" role="switch" id="check-create-classify">
    ...
    <div class="box-create-info-basic" id="box-create-classify">               
        <div class="w-100 item-title-box">
            ...
            <span class="item-count-classify" title="Số lượng phân loại hiện có">(<span id="count-classify">0</span>)</span>
        </div>
        <div class="row">
    ...
    <div class="w-100 item-title-box">
        <center class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="check-create-discount">
